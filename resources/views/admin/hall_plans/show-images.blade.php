...
@section('content')
    ...
    <div class="kasir" id="kasir-images">
        ...
        <div class="kasir__prices">
          <form name="image-load" method="PUT">
            <label class="btn btn-info btn-block">
              Вибрати забраження
              <input type="file" name="file" multiple class="visually-hidden">
            </label>
          </form>
          <div class="kasir__prices-image"></div>
          <button type="submit" class="btn btn-success btn-block" id="loadImage" data-hidden>Завантажити зображення</button>
        </div>
    </div>
