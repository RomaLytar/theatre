...
@section('content')
    ...
    <h1>{{__('admin.editPerformance')}}</h1>
    {{ Html::ul($errors->all()) }}
            ...
            <div role="tabpanel" class="tab-pane active" id="en">
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        {{ Form::text('lang_en',isset($performance->translate('en')->lang) ? $performance->translate->lang  : Input::old('lang_en'), ['class' => 'form-control' ]) }}
                    </div>
            ...
            <div role="tabpanel" class="tab-pane" id="ru">
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        {{ Form::text('lang_ru',isset($performance->translate('ru')->lang) ? $performance->translate->lang  : Input::old('lang_ru'), ['class' => 'form-control' ]) }}
                    </div>
            ...
            <div role="tabpanel" class="tab-pane" id="ua">
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        {{ Form::text('lang_ua',isset($performance->translate('ua')->lang) ? $performance->translate->lang  : Input::old('lang_ua'), ['class' => 'form-control' ]) }}
                    </div>
    ...
    <div class="row">
        <div class="col-md-12 form-group">
            <label class="global__checkbox">
                {{ Form::checkbox('isPremiere', 1, $partner->isPremiere ?? Input::old('isPremiere')) }}
                <span class="global__checkbox-text">{{ __('performance.isPremiere') }}</span>
            </label>
            <label class="global__checkbox">
                {{ Form::checkbox('isSpecial', 1, $partner->isSpecial ?? Input::old('isSpecial')) }}
